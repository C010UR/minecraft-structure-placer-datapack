...
execute if entity @a[tag=complex_construction_raycaster,nbt={SelectedItem: {tag: {structure: "complex_construction:ex_nihilo_water"}}}] run place template complex_construction:compact_machine_ex_nihilo_water ~-6 ~1 ~-6
...
execute if entity @a[tag=complex_construction_raycaster,nbt={SelectedItem: {tag: {structure: "complex_construction:laser_drill"}}}] run place template complex_construction:laser_drill ~-3 ~1 ~-3
