...
execute as @a[scores={click_ex_nihilo_water_wand=1..},nbt={SelectedItem:{tag:{structure:"complex_construction:ex_nihilo_water"}}}] run function complex_construction:place/ex_nihilo_water
execute as @a[scores={click_flux_crafter_wand=1..},nbt={SelectedItem:{tag:{structure:"complex_construction:flux_crafter"}}}] run function complex_construction:place/flux_crafter
